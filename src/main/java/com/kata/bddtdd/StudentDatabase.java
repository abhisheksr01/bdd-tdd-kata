...
public class StudentDatabase {
    ...
    public List<Student> getStudentDetailsFromDB(String namePrefix) {
        ...
        Student student1 = new Student("nagina", "rafique");
        Student student2 = new Student("chaam", "zeina");
        Student student3 = new Student("sabi", "dhiman");
        Student student4 = new Student("kun", "zhang");
        Student student5 = new Student("rashid", "fagan-walcott");
